# -*- coding: utf-8 -*-
"""
Created on Sat Oct 22 18:41:54 2022
...
def amazon_trends(df,risk):
    ...
    merged=pd.concat([pd.DataFrame(df).reset_index(),risk.loc[indices['indices'],:]['Value'].reset_index()],axis=1)
